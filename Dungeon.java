...
public class Dungeon {
	...
	private static void WeaponStatsT2(int Id) {
		...
		switch (Id) {
		    ...
		    //Magic weapons
            case 8:GetStats(flame); break;
            case 9:GetStats(lightning); break;
            case 10:GetStats(frost); break;
        }
    }
	...
	private static void WeaponStatsT3(int Id) {
		...
		switch (Id) {
		    ...
		    //Magic weapons
            case 6:GetStats(sapping); break;
            case 7:GetStats(aura); break;
            case 8:GetStats(speed); break;
            case 9:GetStats(shift); break;
            case 10:GetStats(fireWall); break;
        }
    }
